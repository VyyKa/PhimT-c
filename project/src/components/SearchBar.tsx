            ...
            <form onSubmit={handleSubmit} className="flex items-center">
              <div className="relative">
                <input
                  ...
                  className="w-64 md:w-80 px-4 py-2 pl-10 bg-black/80 border border-gray-600 rounded text-white placeholder-gray-400 focus:outline-none focus:border-red-600 transition-colors backdrop-blur-sm"
                />
            ...
            <AnimatePresence>
              {query.trim() && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute top-full left-0 right-0 mt-2 bg-black/95 backdrop-blur-md border border-gray-700 rounded-lg shadow-xl max-h-96 overflow-y-auto z-50"
                >
                  {isLoading ? (
